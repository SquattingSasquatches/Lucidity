...
public class Course extends DataItem {
	...
	public Course(int id, String name) {
		this(id, 0, name, new Date(0), new Date(0), new Subject(),
				new University());
	}

	public Course(int id, int courseNum, String name, Subject subject,
			University uni) {
		this(id, courseNum, name, new Date(0), new Date(0), subject, uni);
	}

	public Course(int id, int courseNum, Subject subject) {
		this(id, courseNum, "", new Date(0), new Date(0), subject,
				new University());
	}

	public Course(int id, int courseNum, String name, Date startDate,
			Date endDate, Subject subject, University uni) {
		super(id, name);
		this.uni = uni;
	...
	public boolean equalsIgnoreCase(String subject, String courseNum) {
		return subject.toLowerCase().equals(
				getSubject().getPrefix().toLowerCase())
				&& courseNum.equals(String.valueOf(getCourseNum()));
	}
}
